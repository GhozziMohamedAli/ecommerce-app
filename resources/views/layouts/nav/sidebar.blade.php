<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-dark {{$activePage == 'dashboard' ? 'active bg-gradient-info' : '' }} " href="./pages/dashboard.html">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark {{$activePage == 'products' ? 'active bg-gradient-info' : '' }} " href="{{url('/products')}}">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark {{$activePage == 'category' ? 'active bg-gradient-info' : '' }} " href="{{url('/category')}}">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
